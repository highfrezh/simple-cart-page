...
<template>
    <!-- Navigation-->
                    ...
                    <div class="col mb-5"  v-for="product in products" :key="product.id">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center">
                                    <a class="btn btn-outline-dark mt-auto" href="#" @click.prevent="addToCart(product.id)">
                                        Add to cart
                                    </a>
                                </div>
                            </div>
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Copyright &copy; frezhtech 2022</p></div>
        </footer>
</template>
